...
CREATE TABLE `usercalendar` (
  ...
  KEY `UserId` (`UserId`),
  CONSTRAINT `usercalendar_ibfk_1` FOREIGN KEY (`CalendarId`) REFERENCES `calendars` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `usercalendar_ibfk_2` FOREIGN KEY (`UserId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
